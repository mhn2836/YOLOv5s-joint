...
def run(data,
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        if plots and batch_i < 3:
            f = save_dir / f'val_batch{batch_i}_labels.png'  # labels
            Thread(target=plot_images, args=(im, targets, paths, f, names), daemon=True).start()
            f = save_dir / f'val_batch{batch_i}_pred.png'  # predictions
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp22/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--save-hybrid', action='store_true', default=False, help='save label+prediction hybrid results to *.txt')
    ...
    parser.add_argument('--soft', action='store_true', default = False ,help='use soft nms')
