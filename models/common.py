...
from models.Models.research import CARAFE, MP, SPPCSPC, RepConv, BoT3, \
    PatchEmbed, SwinTransformer_Layer, CA, CBAM, Concat_bifpn, Involution, \
        Stem, ResCSPC, ResCSPB, ResXCSPC, ResXCSPB, BottleneckCSPB, BottleneckCSPC, SwinV2_CSPB
...
class SCConv(nn.Module):
    def __init__(self, planes, pooling_r = 3):
...
class C3DCN(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNv2Bottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))